...
$dati = [
    ...
    [
        ...
        [
            ...
            "Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, <span class='c_text'> <a href='#null'>nel Centro Google per la sicurezza online</a> </span>.",
            " <span class='c_text'> <a href='#null'>Scopri</a> </span> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo."
        ],
    ],
    [
        ...
        [
            ...
            " <ol> <li class='spc_text'> La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:",
            "<ol type='a'><li class='spc_text'>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li>",
            "<li class='spc_text'>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li></ol>",
            "</li><li class='spc_text'>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali. </li> </ol>",
...
<body>
    ...
    <section id="site_header">
        <div id="Upheader" class="d-flex p-3">
            <img style="width:80px;" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Google_logo_%282010-2013%29.svg/2560px-Google_logo_%282010-2013%29.svg.png" alt="logo google">
            <h1 class="ms-2">Privacy e Termini</h1>
        </div>
        <!-- /#Upheader -->

        <div id="Downheader">
            <ul class="d-flex m-0 mt-2 ps-3 pb-2 border-bottom">
                <?php for ($i = 0; $i <= count($menu); $i++) { ?>
                    <li class="me-3 list_special">
                        <a href="#null" class="text_special <?php echo ($menu[$i] === 'Domande frequenti') ? 'active' : '' ?>">
                            <?php echo $menu[$i] ?>
                        </a>
                    </li>
                <?php } ?>
